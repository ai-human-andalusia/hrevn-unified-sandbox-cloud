...
def redact_config_for_ui(cfg: CommonConfig) -> Dict[str, object]:
    return {
        ...
        "openai_key_profile": cfg.openai_key_profile,
        "openai_production_api_key_set": cfg.openai_production_api_key_set,
        "openai_demo_api_key_set": cfg.openai_demo_api_key_set,
        "openai_comms_api_key_set": cfg.openai_comms_api_key_set,
